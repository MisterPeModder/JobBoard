...
return [
    ...
    */
    ...
    'lt' => [
        'array' => 'L\'attribut :attribute must have less than :value éléments.',
        'file' => 'L\'attribut :attribute doit être less than :value kilooctets.',
        'numeric' => 'L\'attribut :attribute doit être less than :value.',
        'string' => 'L\'attribut :attribute doit être less than :value caractères.',
    ],
    'lte' => [
        'array' => 'L\'attribut :attribute ne doit pas avoir plus de :value éléments.',
        'file' => 'L\'attribut :attribute doit être less than or equal to :value kilooctets.',
        'numeric' => 'L\'attribut :attribute doit être less than or equal to :value.',
        'string' => 'L\'attribut :attribute doit être less than or equal to :value caractères.',
    ],
    ...
    'max' => [
        ...
        'file' => 'L\'attribut :attribute must not be greater than :max kilooctets.',
        'numeric' => 'L\'attribut :attribute must not be greater than :max.',
        'string' => 'L\'attribut :attribute must not be greater than :max caractères.',
    ],
    ...
    'multiple_of' => 'L\'attribut :attribute doit être a multiple of :value.',
    ...
    'required_if' => 'L\'attribut :attribute est requis quand :other is :value.',
    'required_if_accepted' => 'L\'attribut :attribute est requis quand :other is accepted.',
    'required_unless' => 'L\'attribut :attribute est requis unless :other is in :values.',
    'required_with' => 'L\'attribut :attribute est requis quand :values is present.',
    'required_with_all' => 'L\'attribut :attribute est requis quand :values are present.',
    'required_without' => 'L\'attribut :attribute est requis quand :values is not present.',
    'required_without_all' => 'L\'attribut :attribute est requis quand none of :values are present.',
