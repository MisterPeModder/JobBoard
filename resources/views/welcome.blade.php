...
<body class="antialiased bg-l-bgr-main">
    <header
        ...
        <span class="flex flex-row gap-2">
            @guest
                ...
                <a href="#"
                    class="bg-l-bgr-highlight text-white rounded-full p-1.5 text-sm flex items-center whitespace-nowrap font-semibold">Sign
                    in</a>
            @endguest
    ...
    <main class="container mx-auto py-2">
        <section id="adverts" class="flex flex-row flex-wrap gap-2 px-2">
            ...
            <x-job-advert title="Web 3.0 Developper" company="Licorn Ltd." location="Nantes (44)">
                <x-slot name="shortDescription">
                    <li>Be productive</li>
                    <li>Full stack position</li>
                </x-slot>
            ...
            <x-job-advert title="Technical Director" company="ACME" location="Paris (75)">
                <x-slot name="shortDescription">
                    <li>Be productive</li>
                    <li>Full stack position</li>
                </x-slot>
